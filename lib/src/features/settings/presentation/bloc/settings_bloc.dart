...
class SettingsBloc extends BaseBloc<SettingsEvent, SettingsState> {
  ...
  StreamController<String> languageChangeController = StreamController<String>.broadcast();
  ...
  Future<void> _retrieveSettings(_RetrieveSettingsEvent event, Emitter emit) async {
  ...
  Future<void> _updateSettings(_UpdateSettingsEvent event, Emitter<SettingsState> emit) async {
    try {
